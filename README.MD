...
### 1. Configure as filas e rotas (config publicado da aplicação)
...
### 2. Crie o worker da fila (uma subclasse fina por prioridade ativa)
...
{
    protected $signature = 'priority_default';       // nome usado em RABBITMQ_LARAVEL_WORKERS
